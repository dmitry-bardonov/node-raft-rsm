...
All notable changes will follow Keep a Changelog. Versions will follow Semantic Versioning after the public API is approved.
...
- Durable SQLite, real transport, complete snapshots, full fault/property matrix, and multi-process example.
